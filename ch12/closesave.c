...
main (int argc, char **argv)
{
    ...
    ac = 0;
    toplevel = XtAppInitialize(&app_context, "Closesave", NULL, 0,
    ...
    /* (1) Create atom for "WM_DELETE_WINDOW" */
    xa_wm_delete = XmInternAtom(XtDisplay(toplevel), "WM_DELETE_WINDOW", False);

    /* (2) Register protocol callback for "WM_DELETE_WINDOW" */
...
SaveCB (Widget w, XtPointer client_data, XtPointer call_data)
{
    ...
    /* (4) Do nothing when "Close" button of non-toplevel window is pressed */
